...
public class ProximitySensor
  ...
  public ProximitySensor(
    ...
    LogUtil.v("constructor", "Disable proximity sensor is reported as %s", (mIsProximitySensorDisabled ? "true" : "false"));
    ...
    if (mPowerManager.isWakeLockLevelSupported(PowerManager.PROXIMITY_SCREEN_OFF_WAKE_LOCK)
      ...
      LogUtil.i("Constructor", "Prox sensor disabled, do not aquire a lock");
      mProximityWakeLock = null;
    } else {
      LogUtil.i("Constructor", "Prox sensor unsupported, do not aquire a lock");
      mProximityWakeLock = null;
    }
  ...
  private synchronized void updateProximitySensorMode() {
    ...
    if (mIsProximitySensorDisabled) {
        LogUtil.i("updateProximitySensorMode()", "Prox sensor is disabled by user, do not aquire a lock!");
        return;
    }
