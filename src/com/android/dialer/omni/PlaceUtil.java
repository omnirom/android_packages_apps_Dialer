...
import com.android.dialer.omni.clients.ChSearch;
import com.android.dialer.omni.clients.DeDasOertliche;
import com.android.dialer.omni.clients.FrRechercheInverse;
import com.android.dialer.omni.clients.OpenStreetMap;
import com.android.dialer.omni.clients.UsWhitePages;
    ...
    public static IReverseLookupApi getLocalReverseApi(PhoneNumber phoneNumber) {
        if (phoneNumber != null) {
            ...
            if (countryCode == 1) {
                ...
                return new FrRechercheInverse();
            } else if (countryCode == 41) {
                return new ChSearch();
            } else if (countryCode == 49) {
                return new DeDasOertliche();
            }
        }
    ...
    public static Uri createTemporaryContactUri(Place place) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(place.postalCode)) {
                ...
                formattedAddress = place.postalCode + formattedAddress;
            }
            if (!TextUtils.isEmpty(place.street)) {
                if (!TextUtils.isEmpty(formattedAddress)) {
                    formattedAddress = ", " + formattedAddress;
                }
                formattedAddress = place.street + formattedAddress;
            }
            if (!TextUtils.isEmpty(formattedAddress)) {
