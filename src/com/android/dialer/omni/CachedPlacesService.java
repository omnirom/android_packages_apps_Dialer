...
public class CachedPlacesService {
    ...
    private static final String[] _PROJECTION = new String[] {
            ...
            Place.WEBSITE,                                 // 10
            Place.SOURCE,                                  // 11
            CachedPlacesDatabaseHelper.NORMALIZED_NUMBER,  // 12
            CachedPlacesDatabaseHelper.HAS_IMAGE           // 13
    };
    ...
    private static final int NORMALIZED_NUMBER = 12;
    private static final int HAS_IMAGE = 13;
    ...
    public Place lookupCachedPlaceFromNumber(Context context, String number) {
        ...
        if (!Place.isEmpty(place)
                && TextUtils.isEmpty(place.getPhoneNumber())
        ...
        try {
            ...
            if (cursor != null) {
                if (cursor.moveToFirst()) {
                    ...
                    place.setWebsite(cursor.getString(WEBSITE));
    ...
    public void addPlace(Context context, Place place) {
        ...
        if (!Place.isEmpty(place)) {
            ...
            contentValues.put(Place.WEBSITE, place.getWebsite());
