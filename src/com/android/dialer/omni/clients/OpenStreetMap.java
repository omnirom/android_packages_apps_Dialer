 ...
 */
public class OpenStreetMap implements IPlacesAroundApi, IReverseLookupApi {
    private final static String TAG = OpenStreetMap.class.getSimpleName();
    ...
    private final static String mProviderUrl = "http://overpass.osm.rambler.ru/cgi/interpreter";
    ...
    private List<Place> getPlaces(String request, boolean forceLocation)
        ...
        JSONObject obj = PlaceUtil.postJsonRequest(mProviderUrl,
                        ...
                        for (int j = 0; j < refNodes.length() && Place.isEmpty(place); j++) {
                            ...
                            if (nodes.containsKey(refId)) {
                                ...
                                if (refNode.has("lat") && refNode.has("lon")) {
                                    ...
                                    place.setLatitude(refNode.getDouble("lat"));
                                    place.setLongitude(refNode.getDouble("lon"));
                                }
                            }
                        }
