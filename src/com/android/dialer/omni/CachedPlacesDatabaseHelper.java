...
public class CachedPlacesDatabaseHelper extends SQLiteOpenHelper {
    ...
    private void setupTable(SQLiteDatabase database) {
        ...
        database.execSQL("CREATE TABLE " + TABLE + " (" +
                ...
                Place.PHONE_NUMBER + " TEXT NOT NULL, " +
    ...
    public void deleteOldNumbers() {
        // 30 days
        deleteOldNumbers(30L * 24L * 60L * 60L * 1000L);
    }

    public void deleteOldNumbers(long time) {
        String args[] = new String[] { Long.toString(System.currentTimeMillis() - time) };
        String sql = "DELETE FROM " + TABLE + " WHERE " + TIME_LAST_UPDATED + "<?";
        if (DEBUG) {
            Log.d(TAG, "deleteOldNumbers: " + sql + args[0]);
        }
    ...
    public void deleteSource(String source) {
        ...
        getWritableDatabase().execSQL(
                "DELETE FROM " + TABLE + " WHERE " + Place.SOURCE + "=?", args);
    }
