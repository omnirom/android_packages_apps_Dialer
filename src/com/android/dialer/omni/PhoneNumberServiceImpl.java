    ...
    private class LookupRunnable implements Runnable {
        ...
        private IReverseLookupApi getLocalReverseApi(String phoneNumber) {
        	...
        	if (phoneNumber.startsWith("0030")) {
        		...
        		// return new clients.SearchFrApi();
        ...
        public void run() {
            ...
            // TODO: In parellel, do a local and a public search, and show the first
            ...
            if (phoneNumberInfo == null
            	...
            	Log.d(TAG, "No cached info, looking up number");
                Place place = mReverseLookupClient[LOOKUP_PUBLIC]
                ...
                if (place != null) {
                    phoneNumberInfo = new PhoneNumberInfoImpl(place.getName(),
                            ...
                            mReverseLookupClient[LOOKUP_PUBLIC].getApiProviderName(),
