...
public class DialerPhoneNumberListAdapter extends PhoneNumberListAdapter {
    ...
    public String getSuggestionPhoneNumber(int position) {
        final int listIndex = getSuggestionIndexFromPosition(position);
        return PhoneNumberUtils.convertAndStrip(mPlacesList.get(listIndex).tags.get(OsmApi.Place.TAG_PHONE));
    }
    ...
    public void queryPlaces(final String query) {
        ...
        // after 500ms if the query string didn't change (otherwise
