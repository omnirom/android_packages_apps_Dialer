...
public class DialerPhoneNumberListAdapter extends PhoneNumberListAdapter {
    ...
    public DialerPhoneNumberListAdapter(Context context) {
        ...
        if (DEBUG) {
            ...
            Log.d(TAG, "New instance created: " + stackTrace);
        }
    }
    ...
    public void queryPlaces(final String query) {
        ...
        if (DEBUG) {
            Log.d(TAG, "Looking for places named like \"" + trimmedQuery + "\"" +
                    ", previous query was \"" + mPreviousQuery + "\"");
        }
